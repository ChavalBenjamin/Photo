...
#define AUV2_ENTRY Photo_Entry
#define AUV2_ENTRY_STR "Photo_Entry"
#define AUV2_FACTORY Photo_Factory
#define AUV2_VIEW_CLASS Photo_View
#define AUV2_VIEW_CLASS_STR "Photo_View"

#define AAX_TYPE_IDS 'ITP1'
#define AAX_TYPE_IDS_AUDIOSUITE 'ITA1'
#define AAX_PLUG_MFR_STR "Acme"
#define AAX_PLUG_NAME_STR "Photo\nIPEF"
