...
NOTARIZE_BUNDLE_ID=com.AcmeInc.Photo
NOTARIZE_BUNDLE_ID_DEMO=com.AcmeInc.Photo.DEMO
...
#if [ $DEMO == 1 ]
#then
#  git checkout installer/Photo.iss
#  git checkout installer/Photo.pkgproj
