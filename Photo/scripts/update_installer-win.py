...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Photo Demo Installer\n"
      else:
        line="OutputBaseFilename=Photo Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Photo Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Photo installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Photo Demo installer\n"
     else:
       line="SetupWindowTitle=Photo installer\n"
